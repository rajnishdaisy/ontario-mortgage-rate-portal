...
const aggressiveSearchAliases = {
  ...
  "b side": ["alternative lending", "private lender", "bruised credit", "stated income", "equity focused refinance"],
  bside: ["b side", "alternative lending", "private lender", "bruised credit"],
  "b lender": ["alternative lending", "private lender", "b side", "bruised credit"],
  bruised: ["bruised credit", "alternative lending", "private lender"],
  npx: ["private lender", "b side", "no doc", "residential seconds"],
  eclipse: ["private lender", "exclipse", "b side", "equity focused refinance"],
  exclipse: ["eclipse", "private lender", "b side"],
  bridgewater: ["bridgewater bank", "alternative lending", "b side", "self employed"],
  cwb: ["cwb optimum mortgage", "alternative lending", "b side"],
  "haven tree": ["haventree bank", "alternative lending", "b side"],
  haventree: ["haventree bank", "alternative lending", "bruised credit"],
  fisgard: ["mic", "private lender", "mortgage investment corporation"],
  cmi: ["canadian mortgages inc", "mic", "private lender"],
...
const bSideAndPrivateLenders = [
  {
    ...
    brandColor: "#172554",
    brandAccent: "#38BDF8",
    website: "https://www.google.com/search?q=NPX+mortgage+lender+Canada",
    portal: "NPX broker desk",
    region: "Ontario",
    bdm: "NPX Private Lending Desk",
    email: "Use assigned NPX contact",
    phone: "Use assigned NPX phone",
    rates: { insuredFixed: null, variable: null, conventional: null, alt: null },
    updated: "B-side desk",
    programs: ["Private / MIC / MIE", "Alternative lending", "No Doc", "Verifiable Income", "Equity-focused refinance", "Residential Seconds"],
    guidelines: ["B-side/private placement option for equity-led files, bruised credit, stated-income stories, and short-term bridge needs.", "Confirm current appetite, fees, LTV, location rules, first/second position, and exit strategy before quoting."],
    policyNote: "B-side desk entry. Add current NPX rate sheet, contact, and product matrix when available."
  },
  {
    id: "eclipse",
    name: "Eclipse Mortgage",
    type: "private lender",
    brandColor: "#111827",
    brandAccent: "#F59E0B",
    website: "https://www.google.com/search?q=Eclipse+mortgage+lender+Canada",
    portal: "Eclipse broker desk",
    region: "Ontario",
    bdm: "Eclipse Private Mortgage Desk",
    email: "Use assigned Eclipse contact",
    phone: "Use assigned Eclipse phone",
    rates: { insuredFixed: null, variable: null, conventional: null, alt: null },
    updated: "B-side desk",
    programs: ["Private / MIC / MIE", "No Doc", "Verifiable Income", "Residential Rentals", "Residential Seconds", "Equity-focused refinance"],
    guidelines: ["Private lender path for fast, equity-driven residential files that need manual review outside bank policy.", "Confirm geography, property type, max LTV, lender/broker fees, legal process, and payout/renewal terms."],
    policyNote: "B-side desk entry. Confirm exact Eclipse product names and current private lending matrix before publication."
  },
  {
    id: "bridgewater-bank",
    ...
    portal: "Bridgewater broker resources",
    region: "Ontario",
    bdm: "Bridgewater Alternative Lending Desk",
    email: "Use assigned Bridgewater contact",
    phone: "Use assigned Bridgewater phone",
    rates: { insuredFixed: null, variable: null, conventional: null, alt: 6.89 },
    updated: "B-side desk",
    programs: ["Alternative lending", "Self-employed", "Bruised credit", "Refinance", "Rental", "Equity-focused refinance"],
    guidelines: ["Alternative bank option for broader credit, self-employed, and non-prime scenarios where story and documentation matter.", "Review income reasonability, credit events, property marketability, LTV, and exit plan before submission."],
    policyNote: "B-side desk entry. Replace with Bridgewater's current broker rate and policy bulletin."
  },
  {
    id: "cwb-optimum",
    ...
    portal: "CWB Optimum broker resources",
    region: "Ontario",
    bdm: "CWB Optimum Mortgage Desk",
    email: "Use assigned CWB Optimum contact",
    phone: "Use assigned CWB phone",
    rates: { insuredFixed: null, variable: null, conventional: null, alt: 6.79 },
    updated: "B-side desk",
    programs: ["Alternative lending", "Self-employed", "Bruised credit", "Refinance", "Rental", "New to Canada"],
    guidelines: ["B-side/alternative placement option for files outside prime lender policy with supporting income and credit story.", "Confirm current score tiers, LTV, BFS documents, rental treatment, and exception route."],
    policyNote: "B-side desk entry. Add CWB Optimum rate sheet and escalation details."
  },
  {
    id: "haventree-bank",
    name: "Haventree Bank",
    ...
    brandColor: "#0F766E",
    brandAccent: "#F97316",
    website: "https://www.haventreebank.com/",
    portal: "Haventree broker resources",
    region: "Ontario",
    bdm: "Haventree Alternative Mortgage Desk",
    email: "Use assigned Haventree contact",
    phone: "Use assigned Haventree phone",
    rates: { insuredFixed: null, variable: null, conventional: null, alt: 6.99 },
    updated: "B-side desk",
    programs: ["Alternative lending", "Self-employed", "Bruised credit", "Refinance", "Rental", "Equity-focused refinance"],
    guidelines: ["Alternative mortgage lender option for broader credit, income, and refinance scenarios.", "Confirm income documentation, score bands, location, LTV, fees, and prepayment/renewal conditions."],
    policyNote: "B-side desk entry. Replace with current Haventree broker bulletin."
  },
  {
    id: "community-trust",
    ...
    brandColor: "#006B5F",
    brandAccent: "#8DC63F",
    website: "https://communitytrust.com/",
    portal: "Community Trust broker resources",
    region: "Ontario",
    bdm: "Community Trust Mortgage Desk",
    email: "Use assigned Community Trust contact",
    phone: "Use assigned Community Trust phone",
    rates: { insuredFixed: null, variable: null, conventional: null, alt: 6.74 },
    updated: "B-side desk",
    programs: ["Alternative lending", "Self-employed", "Refinance", "Rental", "HELOC", "Bruised credit"],
    guidelines: ["Alternative and specialty lending path for flexible income, refinance, and non-prime placement.", "Confirm current product availability, score/LTV bands, rental worksheet, and supporting documents."],
    policyNote: "B-side desk entry. Add current Community Trust rate sheet and BDM coverage."
  },
  {
    id: "cmi",
    ...
    brandColor: "#0B4F6C",
    brandAccent: "#01BAEF",
    website: "https://www.canadianlending.ca/",
    portal: "CMI private mortgage desk",
    region: "Ontario",
    bdm: "CMI Broker Support",
    email: "Use assigned CMI contact",
    phone: "Use assigned CMI phone",
    rates: { insuredFixed: null, variable: null, conventional: null, alt: null },
    updated: "MIC desk",
    programs: ["Private / MIC / MIE", "No Doc", "Verifiable Income", "Equity-focused refinance", "Residential Seconds", "Residential Rentals"],
    guidelines: ["MIC/private mortgage option for equity-focused first and second mortgages, bruised credit, and short-term exit strategies.", "Confirm investor appetite, fees, term, LTV, property location, and exit before presenting."],
    policyNote: "MIC desk entry. Private lender costs and borrower suitability must be disclosed clearly."
  },
  {
    id: "fisgard",
    name: "Fisgard",
    ...
    brandColor: "#004225",
    brandAccent: "#C8A44D",
    website: "https://www.fisgard.com/",
    portal: "Fisgard broker resources",
    region: "Ontario",
    bdm: "Fisgard Mortgage Investment Desk",
    email: "Use assigned Fisgard contact",
    phone: "Use assigned Fisgard phone",
    rates: { insuredFixed: null, variable: null, conventional: null, alt: null },
    updated: "MIC desk",
    programs: ["Private / MIC / MIE", "Alternative lending", "Verifiable Income", "Equity-focused refinance", "Residential Seconds"],
    guidelines: ["Mortgage investment corporation/private placement path for equity-backed residential scenarios.", "Confirm approved lending areas, LTV by property, term, fees, legal costs, and renewal assumptions."],
    policyNote: "MIC desk entry. Add current Fisgard term sheet and broker contact."
  },
  {
    id: "alta-west-capital",
    name: "Alta West Capital",
    type: "private lender",
    brandColor: "#581C87",
    brandAccent: "#A855F7",
    website: "https://www.awcapital.ca/",
    portal: "Alta West broker resources",
    region: "Ontario",
    bdm: "Alta West Capital Desk",
    email: "Use assigned Alta West contact",
    phone: "Use assigned Alta West phone",
    rates: { insuredFixed: null, variable: null, conventional: null, alt: null },
    updated: "MIC desk",
    programs: ["Private / MIC / MIE", "No Doc", "Verifiable Income", "Equity-focused refinance", "Residential Seconds", "Residential Rentals"],
    guidelines: ["Private/MIC placement option for equity-led, non-prime, and short-term refinance scenarios.", "Confirm Western/Ontario lending area, fees, LTV, income support, and exit strategy."],
    policyNote: "MIC desk entry. Confirm current Alta West product availability by province."
  },
  {
    id: "threepoint-capital",
    name: "ThreePoint Capital",
    type: "private lender",
    brandColor: "#1F2937",
    brandAccent: "#22C55E",
    website: "https://www.threepointcapital.ca/",
    portal: "ThreePoint broker desk",
    region: "Ontario",
    bdm: "ThreePoint Capital Desk",
    email: "Use assigned ThreePoint contact",
    phone: "Use assigned ThreePoint phone",
    rates: { insuredFixed: null, variable: null, conventional: null, alt: null },
    updated: "MIC desk",
    programs: ["Private / MIC / MIE", "Equity-focused refinance", "Residential Seconds", "Verifiable Income"],
    guidelines: ["Private capital option for manual review, time-sensitive files, and equity-based refinance needs.", "Confirm LTV, location, property marketability, income comfort, fees, and clear repayment path."],
    policyNote: "MIC desk entry. Add current ThreePoint term sheet and approved market list."
  },
  {
    id: "vwr-capital",
    name: "VWR Capital",
    ...
    brandColor: "#7C2D12",
    brandAccent: "#EA580C",
    website: "https://www.vwrcapital.com/",
    portal: "VWR Capital broker resources",
    region: "Ontario",
    bdm: "VWR Capital Desk",
    email: "Use assigned VWR contact",
    phone: "Use assigned VWR phone",
    rates: { insuredFixed: null, variable: null, conventional: null, alt: null },
    updated: "MIC desk",
    programs: ["Private / MIC / MIE", "No Doc", "Verifiable Income", "Equity-focused refinance", "Residential Seconds"],
    guidelines: ["Private lending option for brokers needing flexible, equity-driven mortgage placement.", "Confirm current lending areas, loan size, property types, rates, fees, and closing timeline."],
    policyNote: "MIC desk entry. Add VWR contact and current product matrix."
  },
  {
    id: "riverrock-mic",
    name: "RiverRock MIC",
    ...
    brandColor: "#164E63",
    brandAccent: "#06B6D4",
    website: "https://www.google.com/search?q=RiverRock+MIC+mortgage",
    portal: "RiverRock MIC desk",
    region: "Ontario",
    bdm: "RiverRock MIC Support",
    email: "Use assigned RiverRock contact",
    phone: "Use assigned RiverRock phone",
    rates: { insuredFixed: null, variable: null, conventional: null, alt: null },
    updated: "MIC desk",
    programs: ["Private / MIC / MIE", "Equity-focused refinance", "Residential Seconds", "Residential Rentals"],
    guidelines: ["MIC/private mortgage entry for equity-led first and second mortgage scenarios.", "Confirm exact entity/contact, market appetite, fee structure, max LTV, and exit before quoting."],
    policyNote: "MIC desk entry. Verify current RiverRock contact details before publishing externally."
  },
  {
    id: "capital-direct",
    name: "Capital Direct",
    ...
    brandColor: "#991B1B",
    brandAccent: "#F97316",
    website: "https://www.capitaldirect.ca/",
    portal: "Capital Direct broker resources",
    region: "Ontario",
    bdm: "Capital Direct Mortgage Desk",
    email: "Use assigned Capital Direct contact",
    phone: "Use assigned Capital Direct phone",
    rates: { insuredFixed: null, variable: null, conventional: null, alt: null },
    updated: "Private desk",
    programs: ["Private / MIC / MIE", "Equity-focused refinance", "Residential Seconds", "Verifiable Income"],
    guidelines: ["Private mortgage lender option for equity take-out, debt consolidation, and short-term lending needs.", "Confirm borrower benefit, fee disclosure, property valuation, income support, and exit plan."],
    policyNote: "Private desk entry. Confirm current broker process and jurisdiction before quoting."
  },
  {
    id: "vault-mortgage",
    name: "Vault Mortgage Corporation",
    type: "private lender",
    brandColor: "#312E81",
    brandAccent: "#818CF8",
    website: "https://www.vaultmortgage.com/",
    portal: "Vault broker resources",
    region: "Ontario",
    bdm: "Vault Mortgage Desk",
    email: "Use assigned Vault contact",
    phone: "Use assigned Vault phone",
    rates: { insuredFixed: null, variable: null, conventional: null, alt: null },
    updated: "Private desk",
    programs: ["Private / MIC / MIE", "No Doc", "Verifiable Income", "Equity-focused refinance", "Residential Seconds"],
    guidelines: ["Private mortgage placement option for brokers needing flexible underwriting and short-term capital.", "Confirm rate, fee, term, LTV, title/legal requirements, and exit strategy."],
    policyNote: "Private desk entry. Add current Vault product matrix and contact once confirmed."
  },
  {
    id: "canadian-western-trust",
    name: "Canadian Western Trust",
    type: "alternative",
    brandColor: "#003E7E",
    brandAccent: "#F2A900",
    website: "https://www.cwt.ca/",
    portal: "Canadian Western Trust mortgage resources",
    region: "Ontario",
    bdm: "Canadian Western Trust Desk",
    email: "Use assigned CWT contact",
    phone: "Use assigned CWT phone",
    rates: { insuredFixed: null, variable: null, conventional: null, alt: null },
    updated: "B-side desk",
    programs: ["Alternative lending", "Refinance", "Self-employed", "Equity-focused refinance"],
    guidelines: ["Alternative/trust-company style lender entry for manually reviewed files and broader placement scenarios.", "Confirm mortgage availability, channel rules, underwriting appetite, and current contact before submission."],
    policyNote: "B-side desk entry. Verify current mortgage program and broker access details."
  }
];
